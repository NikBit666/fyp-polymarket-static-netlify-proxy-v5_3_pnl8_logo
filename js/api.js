...
export async function getMarketsCandidate() {
...
export async function getPositions(addr) {
...
export async function getActivity(addr, limit=1000) {
...
export async function getValue(addr) {
...
export function resolveProxyFromActivity(activity) {
...
export function marketLink(slugOrCondition) {
...
export async function getPositionsCount(addr) {
  try {
    const r = await getPositions(addr);
